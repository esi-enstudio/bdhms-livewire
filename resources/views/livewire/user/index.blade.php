<div>
    ...
    <div class="relative max-w-screen-md mx-auto">
        <input type="email" class="rounded-full peer py-3 px-3 ps-14 focus:shadow-md block w-full bg-gray-200 border-transparent focus:border-gray-200 focus:bg-white focus:ring-transparent disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Search in user">
    ...
    <div class="max-w-screen-sm mx-auto pt-4 flex items-center justify-center gap-2">
        <select class="my-2 py-3 px-4 pe-9 block bg-gray-200 border-transparent rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-transparent dark:text-neutral-400 dark:focus:ring-neutral-600">
...
{{--    @endforeach--}}
    <div class="pt-10 grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-4">
        @foreach( $users as $user )
            <div class="w-auto flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
